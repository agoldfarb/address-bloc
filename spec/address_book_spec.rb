RSpec.describe AddressBook do  
  ...
  context  ".import_from_csv" do 
    ...
    it "imports the 1st entry" do
      ...
      check_entry(entry_one, "bobby", "314-678-9067", "bobby@blocmail.com")
    end

    it "imports the 2nd entry" do
      book.import_from_csv("entries_2.csv")
      entry_two = book.entries_2[1]
      check_entry(entry_two, "joey", "234-678-9765", "joey@blocmail.com")
    end

    it "imports the 3rd entry" do
      book.import_from_csv("entries_2.csv")
      entry_three = book.entries_2[2]
      check_entry(entry_three, "janet", "435-556-7689", "janet@blocmail.com")
    end
  end
end
